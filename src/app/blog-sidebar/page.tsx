import PostRelacionado from "@/components/Blog/RelatedPost";
import CompartilharPost from "@/components/Blog/SharePost";
import BotaoTag from "@/components/Blog/TagButton";
import CaixaNewsletter from "@/components/Contact/NewsLatterBox";
import Image from "next/image";
import { Metadata } from "next";
export const metadata: Metadata = {
  title: "Página de Detalhes do Blog | Template Gratuito Next.js para Startup e SaaS",
  description: "Esta é a Página de Detalhes do Blog para o Template Nextjs de Startup",
  // outros metadados
};
const PaginaDeBlogComBarraLateral = () => {
  return (
    <>
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  10 sites incríveis para baixar fotos stock & ativos digitais gratuitamente
                </h1>
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <BotaoTag text="Design" />
                        <BotaoTag text="Desenvolvimento" />
                        <BotaoTag text="Info" />
                      </div>
                    </div>
                    <div className="mb-5">
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <ul className="p-8">
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <PostRelacionado
                      title="Melhor maneira de impulsionar suas vendas online."
                  ...
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <PostRelacionado
                      title="50 Melhores dicas e truques de web design que vão te ajudar."
                  ...
                  <li>
                    <PostRelacionado
                      title="Os 8 melhores construtores de landing pages, revisados"
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <div className="flex flex-wrap px-8 py-6">
                  <BotaoTag text="Temas" />
                  <BotaoTag text="Kit UI" />
                  <BotaoTag text="Tailwind" />
                  <BotaoTag text="Startup" />
                  <BotaoTag text="Negócios" />
                </div>
              </div>
              <CaixaNewsletter />
            </div>
...
export default PaginaDeBlogComBarraLateral;